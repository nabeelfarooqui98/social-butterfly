        ...
        <div class="row">
            ...
            <div class="col-md-3 static">
                <div class="profile-card">
                    ...
                    <h5><a href="timeline.php" class="text-white"></a> <?php echo $userse['fname'] . $userse['lname'];?></h5>
            ...
            <div class="col-md-7">
                ...
                <!-- Post Create Box
                ================================================= -->
                <form name="contentform" action = "scripts/sendpost.php" method="POST" enctype="multipart/form-data">
                    <div class="create-post">
                        <div class="row">
                            <div class="col-md-7 col-sm-7">
                                <div class="form-group">
                                    <img src="images/prof/<?php echo $userse['image'];?>" alt="" class="profile-photo-md" />
                                    <input type="file" name="image" id="image" cols="30" rows="1" class="form-control" placeholder="Write what you wish">
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-5">
                                <div class="tools">
                                    <ul class="publishing-tools list-inline">
                                        <li><a href="newsfeed.php"><i class="ion-compose"></i></a></li>
                                        <li><a href="newsfeedimage.php" onclick><i class="ion-images"></i></a></li>
                                        <li><a href="#"><i class="ion-ios-videocam"></i></a></li>
                                        <li><a href="#"><i class="ion-map"></i></a></li>
                                    </ul>
                                    <button type="submit" id="pubbtn" name="pubbtns" class="btn btn-primary pull-right">Publish</button>
                                </div>
                            </div>
                        </div>
                    </div>
