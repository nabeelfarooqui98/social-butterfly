                            ...
                            <form name="regform" action = "scripts/register.php" method="POST" class="form-inline" >
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        ...
                                        <input id="firstname" class="form-control input-group-lg" type="text" name="f_name" title="Enter first name" placeholder="First name"/>
                                        <p style="color:Tomato;" id="errfn" name="errfn"><small></small></p>
                                    </div>
                                    <div class="form-group col-xs-6">
                                        <label for="lastname" class="sr-only">Last Name</label>
                                        <input id="lastname" class="form-control input-group-lg" type="text" name="l_name" title="Enter last name" placeholder="Last name"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label for="email" class="sr-only">Email</label>
                                        <input id="email" class="form-control input-group-lg" type="text" name="e_mail" title="Enter Email" placeholder="Your Email"/>
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        ...
                                        <input id="password" class="form-control input-group-lg" type="password" name="p_ass" title="Enter password" placeholder="Password"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <input type="date" id="date" class="form-control input-group-lg" type="text" name="d_ob" title="date" />
                                    </div>
                                </div>
                                <div class="form-group gender">
                                    <label class="radio-inline">
                                        <input type="radio" name="genderr" value="M" checked>Male
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="genderr" value="F">Female
                                    </label>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        <label for="city" class="sr-only">City</label>
                                        <input id="city" class="form-control input-group-lg reg_name" type="text" name="c_ity" title="Enter city" placeholder="Your city"/>
                                    </div>
                                    <div class="form-group col-xs-6">
                                        <label for="c_ountry" class="sr-only"></label>
                                        <select name="c_ountry" class="form-control" id="country">
                                ...
                                <button type="submit" onclick="check()" name="regbtn" id="regbtn" class="btn btn-primary" value="register">Register Now</button>
                        </div>
                        </form>
